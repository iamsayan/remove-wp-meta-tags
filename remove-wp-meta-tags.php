...
function rm_custom_admin_styles_scripts() {
    ...
    if ( strpos( $current_screen->base, 'easy-header-footer') !== false ) {
        wp_enqueue_style( 'rm-admin', plugins_url( 'admin/assets/css/admin.min.css', __FILE__ ), array(), rm_print_plugin_version() . time() );
        wp_enqueue_style( 'rm-style', plugins_url( 'admin/assets/css/style.min.css', __FILE__ ), array(), rm_print_plugin_version().time() );
        wp_enqueue_script( 'rm-admin-script', plugins_url( 'admin/assets/js/admin.min.js', __FILE__ ), array(), rm_print_plugin_version() . time() );
    }
}
