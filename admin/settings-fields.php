...
function rm_meta_generator_cb_display() {
    ...
    ?>  <label class="switch">
        ...
        <div class="slider round"></div></label>&nbsp;&nbsp;<span class="tooltip" title="<?php _e( 'Enable this if you want to remove generator meta tag (e.g. WP, LayerSlider, Visual Composer, WPML) from WP head.', 'remove-wp-meta-tags' ); ?>"><span title="" class="dashicons dashicons-editor-help"></span></span>
    <?php
}
...
function rm_meta_wpmanifest_cb_display() {
    ...
    ?>  <label class="switch">
        ...
        <div class="slider round"></div></label>&nbsp;&nbsp;<span class="tooltip" title="<?php _e( 'Enable this if you want to hide manifest output of your wordpress website.', 'remove-wp-meta-tags' ); ?>"><span title="" class="dashicons dashicons-editor-help"></span></span>
    <?php
}
...
function rm_meta_feed_cb_display() {
    ...
    ?>  <label class="switch">
        ...
        <div class="slider round"></div></label>&nbsp;&nbsp;<span class="tooltip" title="<?php _e( 'Enable this if you want to remove feed output from your wordpress website. It will just remove output. To disable feed completely go to \'Disable Options\' tab.', 'remove-wp-meta-tags' ); ?>"><span title="" class="dashicons dashicons-editor-help"></span></span>
    <?php
}
...
function rm_meta_rsd_cb_display() {
    ...
    ?>  <label class="switch">
        ...
        <div class="slider round"></div></label>&nbsp;&nbsp;<span class="tooltip" title="<?php _e( 'Enable this if you want to remove really simple discovery (rsd) output in wordpress head.', 'remove-wp-meta-tags' ); ?>"><span title="" class="dashicons dashicons-editor-help"></span></span>
   <?php
}
...
function rm_meta_short_links_cb_display() {
    ...
    ?>  <label class="switch">
        ...
        <div class="slider round"></div></label>&nbsp;&nbsp;<span class="tooltip" title="<?php _e( 'Enable this if you want to remove all shortlinks from your wordpress website.', 'remove-wp-meta-tags' ); ?>"><span title="" class="dashicons dashicons-editor-help"></span></span>
    <?php
}
...
function rm_posts_rel_link_wp_head_cb_display() {
    ...
    ?>  <label class="switch">
        ...
        <div class="slider round"></div></label>&nbsp;&nbsp;<span class="tooltip" title="<?php _e( 'Enable this if you want to remove adjacent / previous and next post links from wordpress website\'s code.', 'remove-wp-meta-tags' ); ?>"><span title="" class="dashicons dashicons-editor-help"></span></span>
    <?php
}
...
function rm_jquery_migrate_cb_display() {
    ...
    ?>  <label class="switch">
        ...
        <div class="slider round"></div></label>&nbsp;&nbsp;<span class="tooltip" title="<?php _e( 'Enable this if you want to disable jQuery Migrate output on wp head. (not recommended)', 'remove-wp-meta-tags' ); ?>"><span title="" class="dashicons dashicons-editor-help"></span></span>
    <?php
}
...
function rm_meta_viewport_cb_display() {
    ...
    ?>  <label class="switch">
        ...
        <div class="slider round"></div></label>&nbsp;&nbsp;<span class="tooltip" title="<?php _e( 'Enable this if you want to remove viewport meta tag from wp head.', 'remove-wp-meta-tags' ); ?>"><span title="" class="dashicons dashicons-editor-help"></span></span>
    <?php
}
...
function rm_remove_html_comments_cb_display() {
    ...
    ?>  <label class="switch">
        ...
        <div class="slider round"></div></label>&nbsp;&nbsp;<span class="tooltip" title="<?php _e( 'Enable this if you want to remove unwanted html comments of yoast seo or other plugins from wp head.', 'remove-wp-meta-tags' ); ?>"><span title="" class="dashicons dashicons-editor-help"></span></span>
    <?php
}
/*==============================================================================
                                   disable options
...
function rm_meta_feed_disable_cb_display() {
    ...
    ?>  <label class="switch">
        ...
        <div class="slider round"></div></label>&nbsp;&nbsp;<span class="tooltip" title="<?php _e( 'Enable this if you want to disable wordpress feed functionality completely.', 'remove-wp-meta-tags' ); ?>"><span title="" class="dashicons dashicons-editor-help"></span></span>
    <?php
}
...
function rm_meta_xml_rpc_cb_display() {
    ...
    ?>  <label class="switch">
        ...
        <div class="slider round"></div></label>&nbsp;&nbsp;<span class="tooltip" title="<?php _e( 'Enable this if you want to disable wordpress xml-rpc functionality completely.', 'remove-wp-meta-tags' ); ?>"><span title="" class="dashicons dashicons-editor-help"></span></span>
    <?php
}
...
function rm_disable_wpjson_restapi_cb_display() {
    ...
    ?>  <label class="switch">
        ...
        <div class="slider round"></div></label>&nbsp;&nbsp;<span class="tooltip" title="<?php _e( 'Enable this if you want to disable wordpress wpjson, restapi functionality completely. If enabled, plugins like Jetpack does\'t work.', 'remove-wp-meta-tags' ); ?>"><span title="" class="dashicons dashicons-editor-help"></span></span>
    <?php
}
...
function rm_yoast_schema_output_cb_display() {
    ...
    ?>  <label class="switch">
        ...
        <div class="slider round"></div></label>&nbsp;&nbsp;<span class="tooltip" title="<?php _e( 'Enable this if you want to disable yoast seo schema output. This option comes haandy, when you are using any other schema plugin like wp schema pro.', 'remove-wp-meta-tags' ); ?>"><span title="" class="dashicons dashicons-editor-help"></span></span>
    <?php
}
/*==============================================================================
                                   security options
...
function rm_disable_user_enu_cb_display() {
    ...
    ?>  <label class="switch">
        ...
        <div class="slider round"></div></label>&nbsp;&nbsp;<span class="tooltip" title="<?php _e( 'Enable this if you want to stop users enumeration. It prevents hackers from getting wordpress usernames.', 'remove-wp-meta-tags' ); ?>"><span title="" class="dashicons dashicons-editor-help"></span></span>
    <?php
}
...
function rm_enable_xframe_cb_display() {
    ...
    &nbsp;&nbsp;<span class="tooltip" title="<?php _e( 'Enable this if you want to stop other sites from displaying your content in a frame or iframe.', 'remove-wp-meta-tags' ); ?>"><span title="" class="dashicons dashicons-editor-help"></span></span>
    <?php
}
...
function rm_disable_powered_by_cb_display() {
    ...
    ?>  <label class="switch">
        ...
        <div class="slider round"></div></label>&nbsp;&nbsp;<span class="tooltip" title="<?php _e( 'Enable this if you want to hide and unset x-powered-by header from your website.', 'remove-wp-meta-tags' ); ?>"><span title="" class="dashicons dashicons-editor-help"></span></span>
    <?php
}
...
function rm_ver_remove_style_cb_display() {
    ...
    ?>  <label class="switch">
        ...
        <div class="slider round"></div></label>&nbsp;&nbsp;<span class="tooltip" title="<?php _e( 'Enable this if you want remove version from stylesheets.', 'remove-wp-meta-tags' ); ?>"><span title="" class="dashicons dashicons-editor-help"></span></span>
    <?php
}
...
function rm_enable_html_minify_display() {
    ...
    echo "<select id='mliu' name='rm_plugin_global_settings[rm_enable_html_minify]' style='width:10%'>";
    foreach( $items as $item => $label ) {
...
function rm_enable_js_minify_display() {
    ...
    echo "<select id='ejs' name='rm_plugin_global_settings[rm_enable_js_minify]' style='width:10%'>";
    foreach( $items as $item => $label ) {
...
function rm_remove_html_js_css_comment_display() {
    ...
    echo "<select id='ecomment' name='rm_plugin_global_settings[rm_remove_html_js_css_comment]' style='width:10%'>";
    foreach( $items as $item => $label ) {
...
function rm_remove_xhtml_void_display() {
    ...
    echo "<select id='exhtml' name='rm_plugin_global_settings[rm_remove_xhtml_void]' style='width:10%'>";
    foreach( $items as $item => $label ) {
...
function rm_remove_relative_domain_url_display() {
    ...
    echo "<select id='erelative' name='rm_plugin_global_settings[rm_remove_relative_domain_url]' style='width:10%'>";
    foreach( $items as $item => $label ) {
...
function rm_remove_protocol_domain_url_display() {
    ...
    echo "<select id='eprotocol' name='rm_plugin_global_settings[rm_remove_protocol_domain_url]' style='width:10%'>";
    foreach( $items as $item => $label ) {
...
function rm_support_multibyte_encoding_display() {
    ...
    echo "<select id='utf8' name='rm_plugin_global_settings[rm_support_multibyte_encoding]' style='width:10%'>";
    foreach( $items as $item => $label ) {
...
function rm_enable_minify_liu_display() {
    ...
    echo "<select id='mliu' name='rm_plugin_global_settings[rm_enable_minify_liu]' style='width:10%'>";
    foreach( $items as $item => $label ) {
...
function rm_remove_plugin_data_cb_display() {
    $options = get_option('rm_plugin_global_settings');
    ?> <label class="switch">
    <input id="remove-data" name="rm_plugin_global_settings[rm_remove_plugin_data_cb]" type="checkbox" value="1" <?php checked( isset($options['rm_remove_plugin_data_cb']), 1 ); ?> />
    <div class="slider round"></div></label>&nbsp;&nbsp;<span class="tooltip" title="<?php _e( 'Enable this if you want to remove plugin settings at the time of plugin uninstallation.', 'remove-wp-meta-tags' ); ?>"><span title="" class="dashicons dashicons-editor-help"></span></span>
    <?php
}
